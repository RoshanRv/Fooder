  ...
  return (
      <>
        ...
        <title>F🍔🍔der | {pizza.title}</title>
            ...
            <meta property="og:image" content={pizza.img} />
            <meta property="og:title" content={pizza?.title + ' and more!'} />
            <meta
                property="og:description"
                content={pizza?.desc}
            />

            <meta property="twitter:image" content={pizza.img} />
            <meta property="twitter:title" content={pizza?.title + ' and more!'} />
            <meta
